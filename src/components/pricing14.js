        ...
        <div className="pricing14-section-title">
            ...
            {props.content1 ?? (
              <fragment>
                <span className="pricing14-text070 thq-body-small">
                  Get started with our Free Tier plan and explore the world of
                  AI with limited features and resources.
                </span>
              </fragment>
            )}
          </span>
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <fragment>
                  <span className="pricing14-text060 thq-heading-2">
            ...
            <p>
              {props.content2 ?? (
                <fragment>
                  <span className="pricing14-text105 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  <p>
                    {props.plan1 ?? (
                      <fragment>
                        <span className="pricing14-text101 thq-body-large">
                          Free Tier
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <fragment>
                        <span className="pricing14-text067 thq-heading-3">
                          Free
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  <p>
                    {props.plan2 ?? (
                      <fragment>
                        <span className="pricing14-text061 thq-body-large">
                          Business plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <fragment>
                        <span className="pricing14-text064 thq-heading-3">
                          $29/mo
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  <p>
                    {props.plan3 ?? (
                      <fragment>
                        <span className="pricing14-text084 thq-body-large">
                          Enterprise plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <fragment>
                        <span className="pricing14-text056 thq-heading-3">
                          $49/mo
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  <span>
                    {props.plan21 ?? (
                      <fragment>
                        <span className="pricing14-text062 thq-body-large">
                          Business plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <fragment>
                        <span className="pricing14-text075 thq-heading-3">
                          $299/yr
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <span>
                    {props.plan31 ?? (
                      <fragment>
                        <span className="pricing14-text103 thq-body-large">
                          Enterprise plan
                        </span>
                      </fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <fragment>
                        <span className="pricing14-text069 thq-heading-3">
                          $499/yr
                        </span>
                      </fragment>
                    )}
